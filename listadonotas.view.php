...
<div class="body">
 ...
 where id_grado = ".$id_grado." and id_seccion = ".$id_seccion." group by a.id");
            ...
            ?>
            <br>
            <buttom><a href="listadonotas.view.php"><strong>Volver</strong></a></buttom>
            <br>
            <br>
...
<font face="Verdana">
                        ...
                        <tr>
                            ...
                            <?php
                                ...
                                foreach ($notas as $eval => $nota) {
                                    ...
                                    echo '<td align="center" text aling="center"><input type="hidden" 
                    ...
                    <!--Estos crean los promedios finales-->
                    <?php endforeach;?>
