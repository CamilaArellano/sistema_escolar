...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2023 a las 00:07:11
...
INSERT INTO `alumnos` (`id`, `num_lista`, `nombres`, `apellidos`, `genero`, `id_grado`, `id_seccion`, `curp`, `contacto_emergencia`) VALUES
(3, 2, 'David', 'Salguero Erazo', 'M', 1, 1, '', ''),
(4, 3, 'Andy Vladimir', 'Salguero', 'M', 1, 1, '', ''),
(6, 5, 'Eira Camila', 'Arellano Peraza', 'F', 2, 1, 'Abc1', '999999999'),
(7, 4, 'Juan', 'Rodr&iacute;guez', 'M', 2, 2, 'Abc1', '999999999');
...
(222, 9.00, '', 4, 1),
(223, 6.00, '', 4, 1),
(224, 10.00, 'Lectura', 3, 2),
(225, 10.00, 'Lectura', 3, 2),
(226, 10.00, 'Lectura', 3, 2),
(227, 8.00, 'Lectura', 3, 2),
(228, 0.00, '', 4, 2),
(229, 0.00, '', 4, 2),
(230, 0.00, '', 4, 2),
(231, 0.00, '', 4, 2),
