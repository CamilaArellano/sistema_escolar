...
if(!$_POST){
    ...
    // Validar que se completen todos los campos y que las notas estén entre 6 y 10
    for ($i = 0; $i < $num_alumnos; $i++) {
        ...
        for ($j = 0; $j < $num_eval; $j++) {
            ...
            // Verificar si la nota está entre 6 y 10
            if (!is_numeric($nota) || $nota < 6 || $nota > 10) {
                // Nota no válida, redirigir con un mensaje de error
                header('location:notas.view.php?grado=' . $id_grado . '&materia=' . $id_materia . '&seccion=' . $id_seccion . '&revisar=1&err_nota=1');
